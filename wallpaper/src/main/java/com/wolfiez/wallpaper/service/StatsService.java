...
public class StatsService {
    ...
    public List<UserPinStats> getMostActiveUsers(int limit) {
        List<Object[]> results = statsRepository.getMostActiveUsers(PageRequest.of(0, limit));
    ...
    public List<PinLikeStats> getMostLikedPins(int limit) {
        List<Object[]> results = statsRepository.getMostLikedPins(PageRequest.of(0, limit));
        return results.stream()
